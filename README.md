# App-Prototype
Internship Project - App Prototype of Gutermann Company <span style="background-color: #FFFF00">(Only Design no Code would be available due to company policy)</span>
# Intro Layout
